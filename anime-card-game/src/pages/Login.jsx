...
function Login() {
  ...
  return (
    ...
    >
      <div className="w-full max-w-[900px] h-[520px] sm:h-[540px] rounded-2xl overflow-hidden bg-white/[0.04] backdrop-blur-[2px] border border-white/20 shadow-[0_25px_70px_rgba(0,0,0,0.4)] flex flex-col lg:flex-row">
        ...
        <div className="relative w-full lg:w-[58%] h-[220px] lg:h-full flex items-end p-7 sm:p-9 lg:p-11">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-4 max-w-xs text-[11px] text-white/50 leading-relaxed">
              Your cards are waiting. Continue your journey and enter the battle.
            </p>
